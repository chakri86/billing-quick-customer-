...
object SeedData {
    ...
    val menu = listOf(
        ...
        MenuItem("Quick Customer Special Shakes", "Rasmalai", 59),
        MenuItem("Quick Customer Special Shakes", "Kulfi", 59),
        MenuItem("Quick Customer Special Shakes", "Black Current", 59),
        MenuItem("Quick Customer Special Shakes", "American", 69),
        MenuItem("Quick Customer Special Shakes", "Red Velvet", 69),
