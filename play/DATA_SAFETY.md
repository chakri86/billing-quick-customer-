...
- `INTERNET` and `ACCESS_NETWORK_STATE` are present for policy access and the planned synchronization foundation; version 0.7.1 has no server synchronization.
